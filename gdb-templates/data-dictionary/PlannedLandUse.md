#PlannedLandUse
    ...
    <a href="#TableOfficialDocumentation">OfficialDocumentation - Table</a><br/><a href="#FeatureClassSpatialPlan">SpatialPlan - FeatureClass</a><br/><a href="#TableSpatialPlan_member">SpatialPlan_member - Table</a><br/><a href="#TableSpatialPlan_officialDocument">SpatialPlan_officialDocument - Table</a><br/><a href="#TableSpatialPlan_ordinance">SpatialPlan_ordinance - Table</a><br/><a href="#TableSpatialPlan_restriction">SpatialPlan_restriction - Table</a><br/><a href="#FeatureClassSupplementaryRegulation">SupplementaryRegulation - FeatureClass</a><br/><a href="#TableSupplementaryRegulation_dimensioningIndication">SupplementaryRegulation_dimensioningIndication - Table</a><br/><a href="#TableSupplementaryRegulation_officialDocument">SupplementaryRegulation_officialDocument - Table</a><br/><a href="#TableSupplementaryRegulation_specificRegulation">SupplementaryRegulation_specificRegulation - Table</a><br/><a href="#TableSupplementaryRegulation_supplementaryRegulation">SupplementaryRegulation_supplementaryRegulation - Table</a><br/><a href="#FeatureClassZoningElement">ZoningElement - FeatureClass</a><br/><a href="#TableZoningElement_dimensioningIndication">ZoningElement_dimensioningIndication - Table</a><br/><a href="#TableZoningElement_hilucsLandUse">ZoningElement_hilucsLandUse - Table</a><br/><a href="#TableZoningElement_hilucsPresence">ZoningElement_hilucsPresence - Table</a><br/><a href="#TableZoningElement_officialDocument">ZoningElement_officialDocument - Table</a><br/><a href="#TableZoningElement_specificLandUse">ZoningElement_specificLandUse - Table</a><br/><a href="#TableZoningElement_specificPresence">ZoningElement_specificPresence - Table</a><br/>
	<p/><br/>
...
<tr>
	...
	</p></p>	<p><hr/><a name="TableOfficialDocumentation"/>
...
<tr>
	...
	<p><strong>SupplementaryRegulation_dimensioningIndication - Table</strong></p>
	<table width="100%" style="border-color: white">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
...
<tr>
    ...
    <p><hr/><a name="RelationshipClassRelSP_SP_member"/>
	<p><strong>RelSP_SP_member - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelSP_SP_member</td>
			</tr>
			<tr>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">SpatialPlan_member</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelSP_SP_officialDocument"/>
	<p><strong>RelSP_SP_officialDocument - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelSP_SP_officialDocument</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">SpatialPlan_officialDocument</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelSP_SP_ordinance"/>
	<p><strong>RelSP_SP_ordinance - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelSP_SP_ordinance</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">SpatialPlan_ordinance</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelSP_SP_restriction"/>
	<p><strong>RelSP_SP_restriction - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelSP_SP_restriction</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">SpatialPlan_restriction</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelSR_SR_SR"/>
	<p><strong>RelSR_SR_SR - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelSR_SR_SR</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">SupplementaryRegulation</td>
				<td width="30%">featureId</td>
				<td width="30%">RID</td>
			</tr>
		</tbody>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">SupplementaryRegulation_supplementaryRegulation</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelSR_SR_dimensioningIndication"/>
	<p><strong>RelSR_SR_dimensioningIndication - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelSR_SR_dimensioningIndication</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">SupplementaryRegulation_dimensioningIndication</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelSR_SR_officialDocument"/>
	<p><strong>RelSR_SR_officialDocument - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelSR_SR_officialDocument</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">SupplementaryRegulation_officialDocument</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelSR_SR_specificRegulation"/>
	<p><strong>RelSR_SR_specificRegulation - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelSR_SR_specificRegulation</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">SupplementaryRegulation_specificRegulation</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelZE_ZE_dimensioningIndication"/>
	<p><strong>RelZE_ZE_dimensioningIndication - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelZE_ZE_dimensioningIndication</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">ZoningElement_dimensioningIndication</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelZE_ZE_hilucsLandUse"/>
	<p><strong>RelZE_ZE_hilucsLandUse - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelZE_ZE_hilucsLandUse</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">ZoningElement_hilucsLandUse</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelZE_ZE_hilucsPresence"/>
	<p><strong>RelZE_ZE_hilucsPresence - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelZE_ZE_hilucsPresence</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">ZoningElement_hilucsPresence</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelZE_ZE_officialDocument"/>
	<p><strong>RelZE_ZE_officialDocument - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelZE_ZE_officialDocument</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">ZoningElement_officialDocument</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelZE_ZE_specificLandUse"/>
	<p><strong>RelZE_ZE_specificLandUse - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelZE_ZE_specificLandUse</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">ZoningElement_specificLandUse</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
	</table></p><p><hr/><a name="RelationshipClassRelZE_ZE_specificPresence"/>
	<p><strong>RelZE_ZE_specificPresence - RelationshipClass</strong></p>
	<table width="100%">
		<tbody>
			<tr>
				<td width="12%" style="border-color: white"><strong>Name</strong></td>
				<td width="*" style="border-color: white">RelZE_ZE_specificPresence</td>
			</tr>
			<tr>
				<td width="12%" style="border-color: white"><strong>Cardinality</strong></td>
				<td width="*" style="border-color: white">OneToMany</td>
	...
	<table width="50%">
		<tbody>
			...
			<tr>
				<td width="30%">ZoningElement_specificPresence</td>
				<td width="30%"/>
				<td width="30%"/>
			</tr>
		</tbody>
